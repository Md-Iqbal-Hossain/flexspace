...
//       // 🟢 OPTION B: Role Detection from email string
//       const emailVal = email.toLowerCase().trim();
//       if (emailVal.includes("admin")) {
//         localStorage.setItem("flexspace_role", "admin");
//       } else {
//         localStorage.setItem("flexspace_role", "user");
//       }
      
//       // Dispatch explicit update event to lock-in the updated Navbar layouts instantly
//       window.dispatchEvent(new Event("storage_auth_update"));
...
function LoginContent() {
  ...
  const handleLoginSubmit = async (email: string, pass: string) => {
    ...
    try {
      ...
      // Role Detection from email string
      const emailVal = email.toLowerCase().trim();
      if (emailVal.includes("admin")) {
        localStorage.setItem("flexspace_role", "admin");
      } else {
