...
//   // Route Authentication Protection Guard
//   useEffect(() => {
//     // 1. Fetch the actual token containing user/role identity
...
//     try {
//       // 2. Retrieve the token to attach to the request
//       const token = localStorage.getItem("flexspace_token");
...
//           // 🔒 Securely authorize this request on the backend
...
//           price: Number(formData.price),
//           rating: 5.0, // Default star rating rule for freshly created listings
//           availableDate: new Date().toISOString().split('T')[0], // Clears Mongoose schema requirement
//         }),
//       });
...
//         router.push("/explore");
//       } else {
//         // If they are not an admin, the backend will return a 403 error which is caught here
//         setError(data.error || "Failed to create workspace listing.");
//       }
//     } catch (err) {
//       setError("A network error occurred. Please verify your connection.");
